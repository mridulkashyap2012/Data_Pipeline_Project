...
client = boto3.client('emr', region_name='ap-south-1',aws_access_key_id='{}',aws_secret_access_key='{}')
...
def create_emr_cluster():
  ...
  print("The cluster started with cluster id : {'job_flow_id'}".format(cluster_id))
  return cluster_id
...
with dag:
  ...
  op_args=['{{ ti.xcom_pull("create_emr_cluster")["JobFlowId"]}}',
           's3://ap-south-1.elasticmapreduce/libs/script-runner/script-runner.jar', ['s3://irisseta/scripts/ingest.sh']],
  dag=dag, 
  )
